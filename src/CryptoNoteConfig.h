...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(7777777700000000000);
...
const uint64_t START_BLOCK_REWARD                            = (UINT64_C(7777) * parameters::COIN);
const uint64_t MIN_BLOCK_REWARD                              = (UINT64_C(7777) * parameters::COIN);
...
const int      P2P_DEFAULT_PORT                              = 7000;
const int      RPC_DEFAULT_PORT                              = 7001;
